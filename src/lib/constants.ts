 ...
 */
export const APP_NAME: string = 'farchess';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'A chess based onchain base via contract';
 ...
 */
export const APP_TAGS: string[] = ['chess', 'onchain', 'GM'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Launch Farchess';
